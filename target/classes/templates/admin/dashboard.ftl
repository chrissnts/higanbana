            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="sidebar-menu d-flex justify-content-center flex-column text-white">
                        ...
                        <div class="sidebar-item" data-target="studios"><i class="bi bi-building me-2"></i> Studios
                        </div>
                ...
                <div class="col-md-7 ps-4 pe-2">
                    <div class="main-card">
                        ...
                        <div class="card-content" id="users">
                            ...
                            <div class="mb-3"><input type="text" id="userSearch" class="form-control"
                                    placeholder="Search">
                            </div>
                            <div class="table-responsive">
                                <table class="table align-middle mb-0 table-hover">
                                    ...
                                    <tbody>
                                        <#list users as user>
                                            <tr
                                                class="${(user_index % 2 == 0)?then('table-row-dark', 'table-row-light')}">
                                                <td>${user.id}</td>
                        ...
                        <div class="card-content" id="animes">
                            ...
                            <div class="mb-3"><input type="text" id="animeSearch" class="form-control"
                                    placeholder="Search">
                            </div>
                            <div class="table-responsive">
                                <table class="table align-middle mb-0 table-hover">
                                    ...
                                    <tbody>
                                        <#list animes as anime>
                                            <tr
                                                class="${(anime_index % 2 == 0)?then('table-row-dark', 'table-row-light')}">
                                                <td>${anime.id}</td>
                                                ...
                                                <td class="d-flex gap-2">
                                                    ...
                                                    <a href="/animes/${anime.id}/edit"
                                                        class="btn btn-danger btn-sm px-3 fw-bold"><i
                                                            class="bi bi-pencil-fill me-1"></i> EDIT</a>
                                                    <form action="/animes/${anime.id}/delete" method="post"
                                                        onsubmit="return confirm('Are you sure you want to delete?');"
                                                        style="display:inline;">
                                                        <button type="submit"
                                                            class="btn btn-danger btn-sm px-3 fw-bold">
                                            ...
                                            <tr
                                                ...
                                                <td class="d-flex gap-2">
                                                    ...
                                                    <a href="/studios/${studio.id}/edit"
                                                        class="btn btn-danger btn-sm px-3 fw-bold"><i
                                                            class="bi bi-pencil-fill me-1"></i> EDIT</a>
                                                    <form action="/studios/${studio.id}/delete" method="post"
                                                        onsubmit="return confirm('Are you sure you want to delete?');"
                                                        style="display:inline;">
                                                        <button type="submit"
                                                            class="btn btn-danger btn-sm px-3 fw-bold">
                        ...
                        <div class="card-content" id="genres">
                            ...
                            <div class="mb-3"><input type="text" id="genreSearch" class="form-control"
                                    placeholder="Search">
                            </div>
                            <div class="table-responsive">
                                <table class="table align-middle mb-0 table-hover">
                                    ...
                                    <tbody>
                                        <#list genres as genre>
                                            <tr
                                                class="${(genre_index % 2 == 0)?then('table-row-dark', 'table-row-light')}">
                                                <td>${genre.id}</td>
                ...
                <div class="col-md-3 ps-2 pe-4">
                    <div class="stats-card">
                        ...
                        <p class="mb-2">Total Anime <span class="float-end fw-bold text-accent">${totalAnimes}</span>
                        </p>
