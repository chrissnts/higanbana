        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarAnime">
                <ul class="navbar-nav ms-auto align-items-center mb-2 mb-lg-0">
                    <li class="nav-item me-3"><a class="nav-link text-uppercase fw-bold text-white"
                            href="#">DASHBOARD</a></li>
                    <li class="nav-item me-3"><a class="nav-link text-uppercase fw-bold text-white"
                            href="/users">USERS</a></li>
                    <li class="nav-item me-3"><a class="btn btn-danger btn-sm py-lg-2 fw-bold" href="/animes">ANIMES</a>
                    </li>
                    <li class="nav-item">
