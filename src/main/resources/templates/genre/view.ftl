...
<head>
    ...
    <title>View Genre - Higanbana Admin</title>
    ...
    <div class="container mt-5 mb-5">
        <div class="card shadow-lg border-0 rounded-4 p-4">
            <h4 class="fw-bold mb-4 text-uppercase text-red">
                <i class="bi bi-eye me-2"></i> View Genre
            </h4>

            <ul class="list-group list-group-flush">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <span><i class="bi bi-tags-fill me-2"></i> Name</span>
                    <strong>${genre.name! "N/A"}</strong>
                </li>
                ...
                <li class="list-group-item">
                    ...
                    <div class="scroll-box border rounded p-2" style="max-height: 200px; overflow-y: auto;">
                        <#if genre.animes?? && (genre.animes?size > 0)>
                            <#list genre.animes as anime>
            ...
            <div class="mt-4 d-flex justify-content-between">
                ...
                <a href="/genres/${genre.id}/edit" class="btn btn-danger fw-bold px-5 rounded-3 shadow-sm">
                    <i class="bi bi-pencil-square me-1"></i> Edit Genre
                </a>
            </div>
        </div>
    </div>
